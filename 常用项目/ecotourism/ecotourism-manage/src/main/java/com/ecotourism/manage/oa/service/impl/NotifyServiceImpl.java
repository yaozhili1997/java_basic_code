package com.ecotourism.manage.oa.service.impl;

import com.ecotourism.manage.common.utils.ShiroUtils;
import com.ecotourism.manage.system.domain.UserDO;
import com.ecotourism.manage.system.service.SessionService;
...
import com.ecotourism.manage.common.utils.DateUtils;
import com.ecotourism.manage.common.utils.PageUtils;
import com.ecotourism.manage.oa.dao.NotifyDao;
import com.ecotourism.manage.oa.dao.NotifyRecordDao;
import com.ecotourism.manage.oa.domain.NotifyDO;
import com.ecotourism.manage.oa.domain.NotifyDTO;
import com.ecotourism.manage.oa.domain.NotifyRecordDO;
import com.ecotourism.manage.oa.service.NotifyService;
...
//    private SimpMessagingTemplate template;
    ...
    public NotifyDO get(Long id) {
        ...
        rDO.setType(dictService.getName("oa_notify_type", rDO.getType(),ShiroUtils.getUser().getCompanyNo()));
        return rDO;
    }
    ...
    public List<NotifyDO> list(Map<String, Object> map) {
        ...
        for (NotifyDO notifyDO : notifys) {
            notifyDO.setType(dictService.getName("oa_notify_type", notifyDO.getType(), ShiroUtils.getUser().getCompanyNo()));
        }
        return notifys;
    }
