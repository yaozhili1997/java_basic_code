 ...
 */
public class OrderSpotSecondDO implements Serializable {
	...
	//父订单电子票号
	private String parentElectronicTicket;
	//电子票
	...
	//
	private Integer whetherSendRefundTolocal;
	//退票(审核)时间
	 ...
	 * 设置：父订单电子票号
	 */
	public void setParentElectronicTicket(String parentElectronicTicket) {
		this.parentElectronicTicket = parentElectronicTicket;
	}
	/**
	 * 获取：父订单电子票号
	 */
	public String getParentElectronicTicket() {
		return parentElectronicTicket;
	}
	/**
	 * 设置：电子票
	 */
	 ...
	 * 设置：
	 */
	public void setWhetherSendRefundTolocal(Integer whetherSendRefundTolocal) {
		this.whetherSendRefundTolocal = whetherSendRefundTolocal;
	}
	/**
	 * 获取：
	 */
	public Integer getWhetherSendRefundTolocal() {
		return whetherSendRefundTolocal;
	}
	/**
	 * 设置：退票(审核)时间
	 */
