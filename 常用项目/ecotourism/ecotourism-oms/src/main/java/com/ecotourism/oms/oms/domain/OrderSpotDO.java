 ...
 */
public class OrderSpotDO implements Serializable {
	...
	private String supplierResultStatus;

	private String supplierResultMsg;
	...
	public String getSupplierResultStatus() {
		return supplierResultStatus;
	}

	public void setSupplierResultStatus(String supplierResultStatus) {
		this.supplierResultStatus = supplierResultStatus;
	}

	public String getSupplierResultMsg() {
		return supplierResultMsg;
	}

	public void setSupplierResultMsg(String supplierResultMsg) {
		this.supplierResultMsg = supplierResultMsg;
	}
