...
import com.ecotourism.api.common.utils.BuildTree;
import com.ecotourism.api.system.dao.MenuDao;
import com.ecotourism.api.system.dao.RoleMenuDao;
import com.ecotourism.api.system.domain.MenuDO;
import com.ecotourism.api.system.service.MenuService;
...
public class MenuServiceImpl implements MenuService {
	...
	@Override
	public Tree<MenuDO> getTreeByUserId(Long id){
		List<Tree<MenuDO>> trees = new ArrayList<Tree<MenuDO>>();
		List<MenuDO> menuDOs = menuMapper.listByUserId(id);
		for (MenuDO sysMenuDO : menuDOs) {
			Tree<MenuDO> tree = new Tree<MenuDO>();
			tree.setId(sysMenuDO.getMenuId().toString());
			tree.setParentId(sysMenuDO.getParentId().toString());
	...
	@Override
	public Tree<MenuDO> getTree(Long roleId,Long userId) {
		// 根据roleId查询权限
		List<MenuDO> menus = menuMapper.listByUserId(userId);
		...
		List<Tree<MenuDO>> trees = new ArrayList<Tree<MenuDO>>();
		List<MenuDO> menuDOs = menuMapper.listByUserId(userId);
		for (MenuDO sysMenuDO : menuDOs) {
			Tree<MenuDO> tree = new Tree<MenuDO>();
			tree.setId(sysMenuDO.getMenuId().toString());
			tree.setParentId(sysMenuDO.getParentId().toString());
