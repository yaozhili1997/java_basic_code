...
import com.ecotourism.oms.common.annotation.Dict;
 ...
 */
public class SpotTicketDO implements Serializable {
	...
	public int getTotalStockSaleNum() {
		return totalStockSaleNum;
	}

	public void setTotalStockSaleNum(int totalStockSaleNum) {
		this.totalStockSaleNum = totalStockSaleNum;
	}
}
